...
v2 = pt.half_violinplot( x ='Task' , y = 'hand', order = ['Memo', 'Impl'], data = a, palette = ['red', 'white'], bw = .3, cut = 5.,scale = "area", width = .6, inner = None, orient = 'v', alpha = 0.8, ax= ax2, linewidth = 0)
...
ax4.set_ylabel('PLV', fontsize = 16)
...
v2 = pt.half_violinplot( x ='Task' , y = 'visual', order = ['Memo', 'Impl'],data = a, palette = ['red', 'white'], bw = .3, cut = 5.,scale = "area", width = .6, inner = None, orient = 'v', alpha = 0.8, ax= ax5, linewidth = 0)
...
# Diff = pd.DataFrame()
# Impl = a[a.Task == 'Impl'].reset_index()
# Memo = a[a.Task == 'Memo'].reset_index()


# Diff['diff_hand'] = Impl.hand - Memo.hand
# Diff['diff_visual'] = Impl.visual - Memo.visual
# Diff['Difference'] = 'Difference'

# Diff['Subject'] = Impl.Subject
