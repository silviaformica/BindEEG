...
for idx_s, val in enumerate(subjlist):
    ...
    with open(('subj%s_ciPLV.pickle' % (val)), 'wb') as f:
...
for idx_s, val in enumerate(subjlist):
    ...
    os.chdir(saving_path)
    with open(('subj%s_ciPLV.pickle' % (val)), 'rb') as f:
...
ax1.set_ylabel('ciPLV', fontsize = 16)
...
v2 = pt.half_violinplot( x ='Task' , y = 'hand', data = a, palette = ['red', 'white'], bw = .3, cut = 5.,scale = "area", width = .6, inner = None, orient = 'v', alpha = 0.8, ax= ax2, linewidth = 0)
...
ax4.set_ylabel('ciPLV', fontsize = 16)
...
v2 = pt.half_violinplot( x ='Task' , y = 'visual', data = a, palette = ['red', 'white'], bw = .3, cut = 5.,scale = "area", width = .6, inner = None, orient = 'v', alpha = 0.8, ax= ax5, linewidth = 0)
